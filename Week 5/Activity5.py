...
# New Course class
class Course:
    def __init__(self, course_name, course_code, credit_hour, lecturer):
        self.course_name = course_name
        self.course_code = course_code
        self.credit_hour = credit_hour
        self.lecturer = lecturer   # can link with an 'academic' object

    def display_info(self):
        return f"Course Name: {self.course_name}, Code: {self.course_code}, Credit Hour: {self.credit_hour}, Lecturer: {self.lecturer.name}"
...
# Course linked with academic (lecturer)
course1 = Course("Object Oriented Programming", "CS101", 3, academic1)
